...
void SetupStyle() {
    ...
    colors[ImGuiCol_Text] = ImVec4(0.91f, 0.97f, 1.00f, 1.00f);
    colors[ImGuiCol_TextDisabled] = ImVec4(0.40f, 0.59f, 0.65f, 1.00f);

    colors[ImGuiCol_WindowBg] = ImVec4(0.025f, 0.055f, 0.075f, 0.98f);
    colors[ImGuiCol_ChildBg] = ImVec4(0.035f, 0.080f, 0.105f, 0.98f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.035f, 0.075f, 0.100f, 0.99f);

    colors[ImGuiCol_Border] = ImVec4(0.13f, 0.48f, 0.55f, 0.72f);
    colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);

    colors[ImGuiCol_FrameBg] = ImVec4(0.055f, 0.145f, 0.185f, 1.00f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.08f, 0.31f, 0.37f, 1.00f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.10f, 0.47f, 0.53f, 1.00f);

    colors[ImGuiCol_TitleBg] = ImVec4(0.035f, 0.11f, 0.145f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.055f, 0.23f, 0.285f, 1.00f);
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.03f, 0.07f, 0.09f, 1.00f);

    colors[ImGuiCol_MenuBarBg] = ImVec4(0.035f, 0.13f, 0.165f, 1.00f);
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(0.30f, 1.00f, 0.87f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.12f, 0.82f, 0.80f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.35f, 1.00f, 0.94f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.055f, 0.32f, 0.38f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.08f, 0.58f, 0.64f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(0.10f, 0.72f, 0.72f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.055f, 0.28f, 0.34f, 1.00f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.08f, 0.54f, 0.60f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.10f, 0.68f, 0.68f, 1.00f);
    ...
    colors[ImGuiCol_Separator] = ImVec4(0.12f, 0.43f, 0.50f, 0.60f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.20f, 0.86f, 0.82f, 0.85f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.30f, 1.00f, 0.90f, 1.00f);
    colors[ImGuiCol_PlotLines] = ImVec4(0.36f, 0.84f, 1.00f, 1.00f);
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.25f, 0.92f, 0.68f, 1.00f);
