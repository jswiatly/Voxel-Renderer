...
- CI-verified builds on Windows and Linux (MSVC + GCC)
...
- **Cross-platform builds**: Linux ARM, macOS ARM (via MoltenVK).
...
Minecraft: Bedrock Edition showed how good the genre _can_ look before that work stalled.
